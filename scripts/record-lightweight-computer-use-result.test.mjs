...
const workflowResultSheet = buildComputerUseEvidenceResultSheet({
  ...
  workflowEvidence: {
    schedule: {
      ...
      deleted: true,
      weekViewShown: true,
      longTitleEllipsized: true,
      hoverDetailsShown: true,
      updatedThenCreated: true,
      linkedSessionOpened: true,
      todayNavigation: true,
    ...
    chat: {
      ...
      scrollBottomPreserved: true,
      imageThumbnailShown: true,
      attachmentCancelShown: true,
      largePreviewShown: true,
      detailSettingsOverlayShown: true,
      ...
      evidence: [
        ...
        "http://127.0.0.1:8765/api/work-sessions/session-workflow-001/turn/stream",
      ],
    },
    routing: {
      scheduleAndKnowledgeCombined: true,
      fileSearchGuidance: true,
      featureHelpGuidance: true,
      toolFailureRecoveryGuidance: true,
      generalChatSeparated: true,
      evidence: [
        "http://127.0.0.1:8765/api/work-sessions/session-workflow-001/messages",
      ],
    },
    knowledgeIndexing: {
      sourceRegistered: true,
      scanProgressShown: true,
      ingestionProgressShown: true,
      duplicateWorkLocked: true,
      cancelObserved: true,
      dumpViewerOpenable: true,
      structureViewOpenable: true,
      partialWarningShown: true,
      completedCountDrilldown: true,
      sourceCount: 2,
      completedDocumentCount: 3,
      progressPercent: 100,
      evidence: [
        "http://127.0.0.1:8765/api/knowledge/sources",
        "http://127.0.0.1:8765/api/knowledge/ingestion-jobs",
    ...
    knowledge: {
      ...
      sourcePathCount: 2,
      lowQualityWarningShown: true,
      relationDrilldownShown: true,
      graphNodeClicked: true,
      tableEvidenceShown: true,
      sessionKnowledgeSearch: true,
      noEvidenceGraceful: true,
    ...
    document: {
      ...
      openLink: true,
      fromSessionHandoff: true,
      linkedFileUsageCaptured: true,
      fullReportTypeAvailable: true,
      emailTypeAvailable: true,
      customTemplateSelectable: true,
      evidence: [
    ...
    fileSearch: {
      ...
      linkedFileCount: 1,
      linkedListClosable: true,
      emptyStateShown: true,
      resultCount: 2,
      evidence: [
        "http://127.0.0.1:8765/api/files/search",
        "http://127.0.0.1:8765/api/work-sessions/session-workflow-001/file-links",
      ],
    },
    settings: {
      ollamaBaseUrlSaved: true,
      reasoningLowRecommended: true,
      thinkingTraceClean: true,
      gemmaNoResponseGuidanceShown: true,
      featherlessActive: true,
      activeProviderMatchesSaved: true,
      openRouterProfilePreserved: true,
      apiKeyMasked: false,
      uiApiKeyMasked: true,
      uiApiKeyNotVisible: true,
      ...
      evidence: [
        ...
        "http://127.0.0.1:8765/api/settings/llm-test",
      ],
    },
    operations: {
      jobDetailShown: true,
      longJobNavigationSafe: true,
      parallelDifferentResources: true,
      failedJobRetryGuidance: true,
      artifactOpenable: true,
      logCopied: true,
      rightPanelStable: true,
      duplicateSameSessionBlocked: true,
...
const sparseWorkflowResultSheet = buildComputerUseEvidenceResultSheet({
  scenarioSet,
  runtimePolicy,
  session: { id: "session-sparse", title: "Sparse workflow evidence", status: "open" },
  messages: goodMessages,
  appTitleObserved: true,
  engineHealthy: true,
  responseTimeObserved: true,
  workProgressObserved: true,
  recentContextObserved: true,
  screenshotPath: "output/playwright/sparse.png",
  snapshotPath: ".playwright-cli/sparse.yml",
  apiEvidenceBase: "http://127.0.0.1:8765/api/work-sessions/session-sparse",
  workflowEvidence: {
    knowledge: {
      searched: true,
      answered: true,
      ...
      sourcePathCount: 1,
      answerText: "Grounded answer with one citation.",
      evidence: ["http://127.0.0.1:8765/api/knowledge/ask"],
    },
    operations: {
      jobDetailShown: true,
      evidence: ["http://127.0.0.1:8765/api/jobs"],
    },
  },
});
const sparseIds = sparseWorkflowResultSheet.scenarios.map((item) => item.id);
for (const id of [
  "LMUX-08-05",
  "LMUX-08-06",
  "LMUX-08-07",
  ...
  assert.equal(sparseIds.includes(id), false, `${id} should stay untested when optional evidence is absent`);
}
