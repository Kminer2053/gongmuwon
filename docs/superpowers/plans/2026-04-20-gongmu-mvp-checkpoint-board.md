...
| Desktop UI | `npm --workspace apps/desktop run test` | `9 passed` |
...
| W7 | 설치/운영 안정화 | 부분 완료 | runtime badge/manual lifecycle, dev/runbook/tool manifest 정리 | README + /api/tools + Tauri command |
