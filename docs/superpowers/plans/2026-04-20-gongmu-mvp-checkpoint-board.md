...
| 영역 | 명령 | 결과 |
| --- | --- | --- |
| Sidecar API | `.venv/bin/pytest services/sidecar/tests -q` | `6 passed` |
| Desktop UI | `npm --workspace apps/desktop run test` | `2 passed` |
...
| 날짜 | 범위 | 명령 | 결과 | 메모 |
| --- | --- | --- | --- | --- |
| 2026-04-20 | baseline | `.venv/bin/pytest services/sidecar/tests -q` | PASS | `6 passed` |
| 2026-04-20 | baseline | `npm --workspace apps/desktop run test` | PASS | `2 passed` |
